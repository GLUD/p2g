...
socket.on('temp',function (data) {
  ...
  temperatura = parseInt(arrData[2]);
    ...
    var p = this.add.image(600,400, "fondoN").setScale(0.8,0.8);
...
can = this.add.image(1200,570, "caneca").setScale(0.2,0.2);
  ...
  ba1 = this.add.image(600,600, "basura1").setScale(2,2);
  ba2 = this.add.image(800,600, "basura2").setScale(2,2);
  ba3 = this.add.image(360,360, "basura3").setScale(2,2);
  ba4 = this.add.image(480,480, "basura4").setScale(2,2);
  this.physics.world.enable([ ba1, ba2, ba3, ba4 ]);
...
function update(time, delta){
    if (calAire>80){
      p=this.add.image(500,120,"fondoT");

      //repintar();
    }else if (calAire<=80 && calAire > 10){
      //int contador= 0;
      p=this.add.image(500,120,"fondoF");
      //repintar();
    }else {
      //int contador= 0;
      p=this.add.image(500,120,"fondoN");
      ///repintar();
    }
